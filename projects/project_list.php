...
<div class="table-header">
	...
	<p>
		<a class="btn" href="<?= admin_url($identifier, true) ?>"><?=icon('plus')?> Add Project</a>
	</p>
	<?php $table->filters() ?>
</div>
...
<?php foreach($data as $index => $model): ?>
			<tr>
				...
				<td><?= h($model->display('location')) ?></td>
				<td><?= h($model->display('image')) ?></td>
