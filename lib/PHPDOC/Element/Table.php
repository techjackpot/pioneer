...
class Table extends Element implements TableInterface, BlockInterface
{
	...
	const LOOK_FIRST_ROW = 0x20;
	const LOOK_LAST_ROW = 0x40;
	const LOOK_FIRST_COL = 0x80;
	const LOOK_LAST_COL = 0x100;
	const LOOK_NO_HBAND = 0x200;
	const LOOK_NO_VBAND = 0x400;
    ...
    public function __construct($properties = null)
    {
        ...
        if (!$this->properties->has('look'))
        	$this->properties->set('look', 0x1e0);
        $this->grid = array();
        $this->rows = array();
        $this->rowspan = array();
        $this->defaults = array();
